...
<body>
    ...
    class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-amber-100 focus:outline-none focus:ring-2 focus:ring-amber-200 dark:text-gray-400 dark:hover:bg-amber-600 dark:focus:ring-amber-600">
    ...
    <div class="p-4 border-2 border-white">
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div class="flex py-8 h-24 rounded bg-gray-50 dark:bg-clear-400">
                <p class="w-5.5 h-3.5 text-zinc-800 text-5xl font-extrabold font-['Poppins']">Surat Keluar
                </p>
            </div>
      ...
      <p class="text-2xl text-gray-400 dark:text-gray-500">
        ...
        <div class="grid grid-rows-2 gap-4">
            ...
            <div class="flex w-1/2 items-center justify-center rounded bg-gray-50 h-28 dark:bg-clear-800">
                <button type="button"
                    class="px-6 py-3.5 w-full text-base font-medium text-white bg-amber-700 hover:bg-amber-700 focus:ring-4 focus:outline-none focus:ring-amber-300 rounded-lg text-center dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-amber-600">Submit</button>
            </div>
            {{-- <div class="flex items-center justify-center rounded bg-gray-50 h-28 dark:bg-gray-800">
                <p class="text-2xl text-gray-400 dark:text-gray-500">
                    andin
